...
class InstitutionalHoldersInput(BaseToolInput):
    ...
    top_n: int = Field(default=20, description="Number of top holders to return", ge=1, le=100)
...
class InstitutionalHoldersOutput(BaseModel):
    ...
    data: Dict[str, Any] = Field(description="Dictionary containing ticker, top_n, and holder data as CSV")
