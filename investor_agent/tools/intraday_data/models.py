...
class IntradayDataInput(BaseToolInput):
    ...
    window: int = Field(default=200, description="Number of 15-minute bars to fetch", ge=1, le=1000)
...
class IntradayDataOutput(BaseModel):
    ...
    intraday_data: str = Field(description="CSV formatted 15-minute intraday price data in EST timezone or error message")
